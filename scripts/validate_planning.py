...
def validate(workspace: Path) -> dict[str, Any]:
    ...
    issues = [*content_load_issues, *evidence_load_issues, *evidence_issues, *content_issues]
    return {
        "issues": issues,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate content_plan.json and evidence_plan.json.")
